...
import com.example.taskuse.adapter.MainAdapter;
import com.example.taskuse.adapter.MyAdapter;

public class GridViewNews extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grid_view_news);
        ...
        MainAdapter mainAdapter=new MainAdapter(GridViewNews.this,image,name,description);
        gridView.setAdapter(mainAdapter);
        gridView.setOnItemClickListener(new  AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent=new Intent(GridViewNews.this,ListViewDetailPage.class);
        ...
        ima1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GridViewNews.this, MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        ima2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GridViewNews.this, GridViewNews.class);
                startActivity(intent);
            }
        });
        ...
        ima3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GridViewNews.this, ContactUs.class);
                startActivity(intent);
            }
        });
